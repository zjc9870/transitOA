;(function () {
    var FileUpload = function (ele, options) {
        ...
        var fileAllHtml='<div class="files-template"><div class="file-select-template"><div class="fileinput input-group"><div class="form-control">'
						...
						+'accept="application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,image/jpeg,image/png" /></span>'
						...
						+'<p class="tips">提示：不超过20MB，扩展名为doc,docx,jpg,png</p>';
