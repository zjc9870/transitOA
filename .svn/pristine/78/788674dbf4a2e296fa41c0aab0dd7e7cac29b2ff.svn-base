package com.expect.admin.weixin.cp.util.xml;

import java.io.InputStream;
import java.util.HashMap;
import java.util.Map;

import com.expect.admin.weixin.common.util.xml.XStreamInitializer;
import com.expect.admin.weixin.cp.bean.WxCpXmlMessage;
import com.expect.admin.weixin.cp.bean.WxCpXmlOutImageMessage;
import com.expect.admin.weixin.cp.bean.WxCpXmlOutMessage;
import com.expect.admin.weixin.cp.bean.WxCpXmlOutNewsMessage;
import com.expect.admin.weixin.cp.bean.WxCpXmlOutTextMessage;
import com.expect.admin.weixin.cp.bean.WxCpXmlOutVideoMessage;
import com.expect.admin.weixin.cp.bean.WxCpXmlOutVoiceMessage;
