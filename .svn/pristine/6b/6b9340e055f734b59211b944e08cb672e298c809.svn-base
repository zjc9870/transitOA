...
import com.expect.admin.weixin.cp.bean.messagebuilder.FileBuilder;
...
import com.expect.admin.weixin.cp.bean.messagebuilder.VideoBuilder;
import com.expect.admin.weixin.cp.bean.messagebuilder.VoiceBuilder;
