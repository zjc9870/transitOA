    ...
    var t = function() {
            jQuery().datepicker && $(".date-picker").datepicker({
                ...
                $(document).scroll(function() {
                    $("#c_apply_form .date-picker").datepicker("place")
                })
        },
        e = function() {
        ...
        o = function() {
            jQuery().daterangepicker && ($("#defaultrange").daterangepicker({
                ...
                function(t, e) {
                    $("#defaultrange input").val(t.format("YYYY, MMMM D") + " - " + e.format("YYYY, MMMM D"))
                ...
                function(t, e) {
                    $("#defaultrange_modal input").val(t.format("YYYY, MMMM D") + " - " + e.format("YYYY, MMMM D"))
                ...
                function(t, e) {
                    $("#reportrange span").html(t.format("YYYY, MMMM D") + " - " + e.format("YYYY, MMMM D"))
